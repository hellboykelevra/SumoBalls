...
public class MovimientoBola2D : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (tipoControl == TipoControl.WASD)
        {
            ...
            inputVertical = (Input.GetKey(KeyCode.W) ? 10 : 0) + (Input.GetKey(KeyCode.S) ? -1 : 0);
        }
        else if (tipoControl == TipoControl.Flechas)
        {
            ...
            inputVertical = (Input.GetKey(KeyCode.UpArrow) ? 10 : 0) + (Input.GetKey(KeyCode.DownArrow) ? -1 : 0);
        }
